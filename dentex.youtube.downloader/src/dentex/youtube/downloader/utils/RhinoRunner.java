...
public class RhinoRunner {
	...
	public static void runner() { // TODO fetch the function from http://userscripts.org/scripts/review/25105 for auto update!!!
		...
		try {
		    ...
		    Object result = fct.call(rhino, scope, that, new Object[] {ShareActivity.s});
		    
		    ShareActivity.sDeciphered = (String) Context.jsToJava(result, String.class);
