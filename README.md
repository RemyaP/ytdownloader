...
MD5 checksum: // TODO: generate apk
...
================================================================
    ...
    (YouTubeDownloader for Android Copyright (C) 2013 Samuele Rini). 
     ...
     The FFmpeg binary (http://www.ffmpeg.org/index.html), used for the audio 
     extraction feature, is released under the GPL-3.0. 
    ...
    (mpglib Copyright (C) 1995-1997 Michael Hipp). 
     ...
     (http://www.fightingquaker.com/myid3 and https://sites.google.com/site/eternalsandbox/myid3-for-android) 
    ...
    (MyID3 Copyright (C) 2008 Charles M. Chen, adapted for Android by Romulus Urakagi Ts`ai). 
     ...
     For more informations, refer to the dedicated menus and to the license files available from this project`s source code.
    ...
    The text of the license can be found in the LICENSE_GPL file or at https://www.gnu.org/licenses/gpl-3.0.txt 
     ...
     2) Stack Overflow (http://stackoverflow.com), a question and answer site for programmers 
     where all the content is CC BY-SA 3.0 licensed (see http://creativecommons.org/licenses/by-sa/3.0). 
